        ...
        {plans.map((plan) => {
          ...
          return (
            <View key={plan.tier} style={[styles.card, { width: CARD_WIDTH, borderColor: plan.colors.primary, shadowColor: plan.colors.glow }]}>
              ...
              <TouchableOpacity
                style={[styles.selectButton, { backgroundColor: isCurrent ? palette.bgCardAlt : plan.colors.primary }]}
...
function makeStyles(palette: Palette) {
  return StyleSheet.create({
    ...
    closeButton: { width: 32, height: 32, borderRadius: radii.pill, backgroundColor: palette.bgCard, alignItems: "center", justifyContent: "center" },
    card: {
    ...
    planName: { ...typography.h1, color: palette.textPrimary, marginTop: spacing.sm },
    tagline: { ...typography.body, color: palette.textSecondary },
    price: { ...typography.h2, marginTop: spacing.sm },
    specs: { marginTop: spacing.md, gap: 4 },
    specLine: { ...typography.body, color: palette.textSecondary },
